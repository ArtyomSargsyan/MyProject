...
<nav class="navbar navbar-expand-md fixed-top  "  id="mainNav">
  <a class="navbar-brand rounded-circle " href="index.php" >
  ...
  <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link a1" href="index.php"><?php if($lang=='en'){
                      echo 'DAY FIRST';
...
<a href="caxikner.php"> <img src="img/brabion.jpg" width="1440" height="710" alt="Los Angeles"></a>     
    </div>
    <div class="carousel-item" >
      <img src="img/brabion1.jpg" width="1440"
      height="710" 
      alt="Chicago">
    </div>
    </div>
...
<div class="row ">
 <div class="col-md-4 p-5">
   <img src="img/brabion2.png " width="327px" height="300px">
 </div>
 <div class="col-md-4 p-5">
   <img src="img/brabion3.png" width="327px" height="300px">
 </div>
 <div class="col-md-4 p-5">
   <img src="img/brabion4.png" width="327px" height="300px">
 </div>
  </div>
</div>
