                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th>#</th>";
                                        echo "<th>title_EN</th>";
                                        echo "<th>description_EN</th>";
                                        echo "<th>content_EN</th>";
                                        echo "<th>title_HY</th>";
                                        echo "<th>description_HY</th>";
                                        echo "<th>content_HY</th>";
                                ...
                                while($row = $result->fetch()){
                                    echo "<tr>";
                                        ...
                                        echo "<td>" . $row['title_hy'] . "</td>";
                                        echo "<td>" . $row['description_hy'] . "</td>";
                                        echo "<td>" . $row['content_hy'] . "</td>";
